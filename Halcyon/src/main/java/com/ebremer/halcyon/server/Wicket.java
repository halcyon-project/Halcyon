...
public class Wicket {
    ...
    public FilterRegistrationBean<WicketFilter> wicketFilterRegistration(){
        ...
        registration.addInitParameter(IGNORE_PATHS_PARAM, "/callback,/h2,/skunkworks/,/login,/auth,/three.js/,/multi-viewer/,/iiif/,/halcyon/,/images/,/favicon.ico,/rdf,/talon/,/threejs/,/rdf/,/zephyr/");
        return registration;
    }
}
