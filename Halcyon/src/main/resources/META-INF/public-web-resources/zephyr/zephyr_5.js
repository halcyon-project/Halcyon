...
class ImageViewer extends LOD {
    constructor(renderer, url, width, height, x, y, w, h, tilex, tiley, offset, info, level, name, a, b) {
        super();
        if (name.startsWith("ROOT/SE/")) {
            console.log("ImageViewer( "+name +" "+width+" "+height+" "+tilex+" "+tiley+" "+offset+" "+level+" "+a+" "+b+")");
        }
        ...
        //console.log("HERE : "+tilex+" "+numtilesx+" "+level);
        const tw = 2 * tilex * Math.ceil( width / ( 2 * tilex * numtilesx ));
        var h1 = numtilesx          *      Math.ceil( width / ( 2 * tilex * numtilesx ));
        var h3 = 2 * tilex * h1;
        var h4 = h3 / numtilesx;
        if (name.startsWith("ROOT/SE/")) console.log("split : "+name+" "+h1+" "+h3+" "+h4+" "+numtilesx+" "+numtilesy);
        //console.log("2nd: "+tw+"  "+ Math.ceil( width /  2 * tilex  * numtilesx ));
        ...
        if (name.startsWith("ROOT/SE/")) console.log(name+" 3rd : "+a+" "+b+" "+tw+" "+th+" "+ttw+" "+tth+" "+ts);
