...
import com.ebremer.halcyon.wicket.osd.OSDPanel;
...
public class View extends WebPage implements IMarkupResourceStreamProvider, IMarkupCacheKeyProvider {

        private static final long serialVersionUID = 1L;

        public View() {
            System.out.println("OSD View");
            final Label l = new Label("msg", "Halcyon OpenSeadragon Integration");
            add(l);
            OSDPanel osd = new OSDPanel("viewer1", "GRAH!");
            osd.setVisible(true);
            add(osd);
